...
public partial class BarcodePage : ContentPage
{
    ...
    private readonly string[] BarcodeHRIs = { "Above QRCode", "Below QRCode", "Above and below QRCode" };
    private readonly string CANCEL_OPTION_TEXT = "Cancel";
    ...
    {
        var barcodePreview = this.FindByName<BarcodeGeneratorView>("BarcodeImageView");
        ...
        barcodePreview.Format = (ZXing.Net.Maui.BarcodeFormat)BarcodeModels[0].Format;
        barcodePreview.Value = DEFAULT_BARCODE_VALUE;
    }
    ...
    private async void OnBarcodeChange(object sender, EventArgs e)
    {
        ...
        barcodePreview.Value = barcodeContent;
    }
    ...
    private async void OnModelChange(object sender, EventArgs e)
    {
        ...
        barcodePreview.Format = (ZXing.Net.Maui.BarcodeFormat)barcodeFormat.Format;
    }
    ...
    private Barcode GetBarcodeEntity()
    {
        ...
        return new Barcode(contentLabel.Text, barcodeFormat, HRILabel.Text.IndexOf(HRILabel.Text), width, height, cutLabel.IsToggled);
    }
    ...
    private async void OnPrint(object sender, EventArgs e)
    {
        try
        {
            SunmiPrinter.Current.PrintBarcode(GetBarcodeEntity());
        }
